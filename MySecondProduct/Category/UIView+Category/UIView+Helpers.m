...
- (void)createGradientViewFromColors:(NSArray *)colors andType:(GradientType)type
{
    UIImageView *imageview = [[UIImageView alloc] initWithFrame:CGRectMake(0.0, 0.0, self.frameSizeWidth, self.frameSizeHeight)];
    [imageview setImage:[UIImage createGradientViewFromColors:colors
                                                     andType:type
                                                      andSize:CGSizeMake(self.frameSizeWidth, self.frameSizeHeight)]];
